...
#화면 타이틀 설정
pygame.display.set_caption("PangGAME") #게임 이름
...
current_path = os.path.dirname(__file__) #현채 파일의 위치 반환
...
#캐릭터 만들기
character = pygame.image.load(os.path.join(image_path,"apple.png"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path,"ballon11.png")),
    pygame.image.load(os.path.join(image_path,"ballon22.png")),
    pygame.image.load(os.path.join(image_path,"ballon33.png")),
    pygame.image.load(os.path.join(image_path,"ballon44.png"))
]
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        #가로 벽에 닿았을 때 공 이동 위치 변경 (팅겨나오는 효과)
...
#게임 오버 메시지
msg = game_font.render(game_result , True, (155,17,30))
